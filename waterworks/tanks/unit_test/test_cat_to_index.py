...
class TestCatToIndex(th.TestTank):
  def test_int(self):
    ...
    self.pour_pump(td.cat_to_index, {'cats': 1, 'cat_to_index_map': cat_to_index_map}, {'target': 0, 'missing_vals': [], 'cat_to_index_map': cat_to_index_map, 'input_dtype': int}, type_dict={'cats': int, 'cat_to_index_map': dict})

  def test_float(self):
    cat_to_index_map = {1.: 0, 2.: 1, 3.: 2}
    self.pour_pump(td.cat_to_index, {'cats': 1., 'cat_to_index_map': cat_to_index_map}, {'target': 0, 'missing_vals': [], 'cat_to_index_map': cat_to_index_map, 'input_dtype': float}, type_dict={'cats': int, 'cat_to_index_map': dict})
  ...
  def test_one_d(self):
    ...
    self.pour_pump(
      ...
      {'target': np.array([-1, 2]), 'missing_vals': [2.0], 'cat_to_index_map': cat_to_index_map, 'input_dtype': np.float64},
      type_dict={'cats': np.ndarray, 'cat_to_index_map': dict}
    )
