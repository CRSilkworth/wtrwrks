...
class RecipePack(ta.Tank):
  """More efficiently pack in the data of an array according to how another array was packed.
  e.g.
  ...
  func_name = 'recipe_pack'
  slot_keys = ['a', 'default_val', 'is_default']
  tube_keys = ['target', 'default_val', 'is_default']

  def _pour(self, a, default_val, is_default):
    """
    ...
    return {'target': target, 'is_default': is_default, 'default_val': default_val}
